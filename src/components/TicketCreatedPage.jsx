  ...
  return (
    <div className="main-background">
      ...
      <div className="center-big-label">
        <label>Congrats, {name} Your ticket is ready.</label>
      </div>
      <div className="description-label" style={{ marginTop: "80px" }}>
        <label>
          We've emailed your ticket to {emailCurrent} and will send updates in
          the run up to the event.
        </label>
      </div>

      <div className="ticket-space">
        <img src={patternTicket} className="img-ticket"></img>
        <div className="logo-of-ticket">
          <img style={{ width: "20px" }} src={logo}></img>
        </div>
        <div className="name-of-ticket">Coding of Greatness</div>
        <div className="date-of-ticket">
          {formattedDate} / {cityTicket}{" "}
        </div>
        <div className="image-of-ticket">
          <img src={imageFile} className="ticket-card" alt="Ticket" />
          <div className="owner-ticket">
            {" "}
            <label>{fullName}</label>
          </div>
          <div className="github-owner-ticket">
            <img src={iconGithub} style={{ marginRight: "10px" }}></img>
